...
public class DosenTidakTetap extends Dosen {
    ...
    public DosenTidakTetap(String nama, String nik, int umur, char jenisKelamin, String istansi, int jamMengajar, double honorPerJam) {
        super(nama, nik, umur, jenisKelamin, istansi);
    ...
    public void tampilkanInfo() {
        ...
        System.out.println("masukkan nama universitas: "+ getIstansi());
